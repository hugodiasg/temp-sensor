...
C {devices/vsource.sym} -120 -80 1 0 {name=Vin value="PULSE(0V	1.8V	0.5ns	0.1ns	0.1ns	6ns	12ns)"}
...
C {devices/code_shown.sym} 410 -410 0 0 {name=Simulation only_toplevel=false value=".tran 0.01n 8n
.control
destroy all
run
let id =-i(vdd)
