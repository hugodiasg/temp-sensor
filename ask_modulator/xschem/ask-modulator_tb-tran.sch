...
C {devices/vsource.sym} -60 -140 2 0 {name=Vin value="PULSE(0V	1.8V	0.5ns	0.1ns	0.1ns	100ns	200ns)"}
...
C {devices/code_shown.sym} 400 -485 0 0 {name=Simulation only_toplevel=false value="
*.tran 0.3n 110n
*.tran 0.5n 200n
.tran 1n 1000n
.control
