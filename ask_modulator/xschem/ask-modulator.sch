...
S {}
E {}
T {L=993p} 430 -290 0 0 0.4 0.4 {}
T {
3 x C (//) = 3.627 pF} 130 -220 0 0 0.4 0.4 {}
T {R = 28.861 kohms} 817.5 -215 2 0 0.4 0.4 {}
N 360 -130 402.5 -130 {
lab=out}
N 360 -60 360 -37.5 {
lab=gnd}
...
C {sky130_fd_pr/cap_mim_m3_2.sym} 360 -190 0 0 {name=C0 model=cap_mim_m3_2 W=24.4 L=24.4 MF=3 spiceprefix=X}
