...
C {/home/hugodg/projects-sky130/temp-sensor/impedance-transformer/xschem/impedance-transformer-pex.sym} 160 -80 0 0 {name=x1}
C {/home/hugodg/projects-sky130/temp-sensor/impedance-transformer/xschem/impedance-transformer-pex.sym} 150 200 0 0 {name=x2}
C {devices/res.sym} -512.5 200 3 0 {name=R1
value=191.6
footprint=1206
device=resistor
m=1}
C {devices/capa.sym} -452.5 200 3 0 {name=C1
m=1
value=19.6852p
footprint=1206
device="ceramic capacitor"}
C {devices/res.sym} -355 -80 3 0 {name=R2
value=191.6
footprint=1206
device=resistor
m=1}
C {devices/capa.sym} -295 -80 3 0 {name=C2
m=1
value=19.6852p
footprint=1206
device="ceramic capacitor"}
