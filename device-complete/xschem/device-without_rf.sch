...
C {devices/lab_pin.sym} -455 70 1 0 {name=l16 sig_type=std_logic lab=vpwr}
...
C {devices/lab_pin.sym} -930 160 1 0 {name=l40 sig_type=std_logic lab=out_buf}
...
C {devices/lab_pin.sym} -685 70 0 0 {name=l2 sig_type=std_logic lab=vd}
...
C {/foss/designs/temp-sensor/sensor/xschem/sensor-no-dummies.sym} -1295 170 0 0 {name=x3}
C {/foss/designs/temp-sensor/buffer/xschem/buffer-no-dummies.sym} -1035 160 0 0 {name=X2}
