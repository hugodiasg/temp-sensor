...
C {devices/isource.sym} -75 -35 0 0 {name=ibias value=20u}
...
C {devices/lab_pin.sym} -75 5 0 0 {name=l17 sig_type=std_logic lab=ib}
...
C {devices/sqwsource.sym} -65 -245 0 0 {name=V1 vhi=1 freq=1k}
...
C {/foss/designs/temp-sensor/buffer/xschem/buffer-pex.sym} 420 -220 0 0 {name=X1}
C {devices/capa.sym} 520 -190 0 0 {name=Cl
m=1
value=4p
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 520 -160 0 0 {name=l16 lab=GND}
C {devices/lab_pin.sym} -75 -75 0 0 {name=l3 sig_type=std_logic lab=vd}
